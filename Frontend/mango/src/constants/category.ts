...
export const CATEGORIES: Record<CategoryType, CategoryInfo> = {
  hotplace: {
    ...
    emoji: '🔥',
    shortDescription:
      '인기 장소를 즐기며, 문화생활과 취미를 활발히 즐기는 유형',
    detailedDescription:
  ...
  shopping: {
    ...
    emoji: '🛍️',
    shortDescription:
      '쇼핑을 즐기고 다양한 상품을 찾아보고 구매하는 데 적극적인 유형',
    detailedDescription:
  ...
  artist: {
    ...
    emoji: '🎨',
    shortDescription:
      '예술과 창작 활동에 관심이 많고, 문화적 감수성이 풍부한 유형',
    detailedDescription:
  ...
  beauty: {
    ...
    emoji: '💄',
    shortDescription:
      '뷰티 트렌드에 관심이 많고 꾸준히 자기관리에 투자하는 유형',
    detailedDescription:
  ...
  airport: {
    ...
    emoji: '✈️',
    shortDescription:
      '국내외 여행과 이동을 즐기며, 다양한 지역의 경험을 추구하는 유형',
    detailedDescription:
  ...
  study: {
    ...
    name: '자기계발형',
    emoji: '📚',
    shortDescription: '공부와 학습, 개인의 성장을 위해 투자하는 유형',
    detailedDescription:
  ...
  sports: {
    ...
    name: '스포츠형',
    emoji: '🏃',
    shortDescription: '스포츠 관람·참여를 즐기고, 건강 관리에 적극적인 유형',
    detailedDescription:
  ...
  cozyroom: {
    ...
    emoji: '🏠',
    shortDescription:
      '집에서 시간을 보내며 온라인 쇼핑, 배달 서비스 등을 즐기는 유형',
    detailedDescription:
