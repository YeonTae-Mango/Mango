...
export default function RadiusForm({ 
  ...
  const distanceIndex = distanceOptions.findIndex(option => option >= currentRadius);
  ...
  return (
    <View className="flex-1 pt-10">
      ...
      <View className="px-4 mb-6">
        <Text className="text-subheading-bold text-text-primary mb-6">희망하는 반경</Text>
        ...
        <View className="flex-row items-center justify-center gap-3">
          ...
          <Text className="text-body-large-regular text-text-primary">
            자동차로 <Text className="font-bold">{timeRanges[distanceIndex]?.min || 0}~{timeRanges[distanceIndex]?.max || 0}분</Text> 정도 걸려요!
          </Text>
        </View>
